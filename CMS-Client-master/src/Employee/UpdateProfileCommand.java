...
public class UpdateProfileCommand implements MenuCommand {
    ...
    public UpdateProfileCommand(PrintWriter out, BufferedReader in, BufferedReader stdIn, String employeeId) {
        this.stdIn = stdIn;
        this.out = out;
        this.in = in;
    ...
    public void execute() throws IOException {
        ...
        profile.setSpice(spice);
        profile.setCuisineType(cuisineType);
